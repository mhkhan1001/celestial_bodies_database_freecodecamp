...
CREATE TABLE public.planet (
    planet_id integer NOT NULL,
    name character varying(40) NOT NULL,
    orital_period_in_years numeric(5,2) NOT NULL,
...
CREATE TABLE public.star (
    star_id integer NOT NULL,
    name character varying(40) NOT NULL,
    dist_in_light_years numeric(5,2) NOT NULL,
    star_brightness numeric(5,2) NOT NULL,
    approval_date date,
    galaxy_id integer NOT NULL
);
...
INSERT INTO public.constellation VALUES (7, 'Coma Berenices', NULL, 'Berenices hair', 6);
...
INSERT INTO public.galaxy VALUES (3, 'Black Eye Galaxy', 'It looks like an eye with a dark stripe undern', false, 7);
...
INSERT INTO public.galaxy VALUES (8, 'Butterfly Galaxies', 'Binary galaxies. It looks like a pair of butterfly', false, 13);
INSERT INTO public.galaxy VALUES (9, 'Sombrero Galaxy', 'Looks like a sombrero', false, 13);
INSERT INTO public.galaxy VALUES (10, 'Little Sombrero Galaxy', 'It looks like a sombrero, but it’s smaller than', false, 10);
INSERT INTO public.galaxy VALUES (11, 'Milky Way', 'Our own galaxy. It is said to look like a band', true, 11);
...
INSERT INTO public.moon VALUES (18, 'Triton', 1846, 2720, 8);
INSERT INTO public.moon VALUES (19, 'Hydra', 2005, 61, 11);
INSERT INTO public.moon VALUES (20, 'Kerberos', 2011, 28, 11);
INSERT INTO public.moon VALUES (21, 'Styx', 2012, 20, 11);
...
INSERT INTO public.planet VALUES (17, 'Sedna', 120.59, 0.43, false, 8);
...
INSERT INTO public.star VALUES (4, 'Deneb Algedi', 39.00, 2.85, '2017-01-02', 11);
